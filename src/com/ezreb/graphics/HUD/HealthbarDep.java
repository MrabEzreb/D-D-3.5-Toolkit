...
@Deprecated
public class HealthbarDep extends Component {
	...
	public HealthbarDep(int maxHealth) {
		this(maxHealth, 0);
	}
	public HealthbarDep(int maxHealth, int curHealth) {
		...
		this.addHierarchyListener(new HierarchyListener() {
			...
			public void hierarchyChanged(HierarchyEvent arg0) {
				if(HealthbarDep.this.isDisplayable()) {
					HealthbarDep.this.setBounds(25, 50, 201, 21);
					HealthbarDep.this.validate();
					try {
						HealthbarDep.this.draw();
					} catch (IOException e) {
...
//		});
	...
	public void draw() throws IOException {
		...
		if(HealthbarDep.this.getParent()!=null) {
			...
			if(this.curHealth!=0) {
				...
				Rectangle ealth = new Rectangle(0, 0, (int) Math.floor((ch/mh)*200), 20);
	...
	public HealthbarDep setHealthMax(int h) throws IOException {
		this.maxHealth = h;
		this.draw();
		return this;
	}
	public HealthbarDep setHealth(int h) throws IOException {
		this.curHealth = h;
		this.draw();
		return this;
	}
